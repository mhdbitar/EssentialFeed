...
class LoadFeedFromCacheUseCaseTests: XCTestCase {
    ...
    func test_load_deleteCacheOnLessThenSevenDaysOldCache() {
        let feed = uniqueImageFeed()
        let fixedCurrentDate = Date()
    ...
    private func expect(_ sut: LocaleFeedLoader, toCompleteWith expectedResult: LocaleFeedLoader.LoadResult, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
