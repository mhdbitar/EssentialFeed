...
//
//  Created by Mohamd Bitar on 1/4/22.
//
...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedImageView_loadImageURLWhenVisible() {
        ...
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url], "Expected second image URL request second view also become visible")
    }
    ...
    func test_feedImageViewRetryButton_isVisibleOnImageURLLoadError() {
        ...
        XCTAssertEqual(view1?.isShowingRetryAction, true, "Expected retry action for second view once image loading completes with error")
    }
    ...
    func test_feedImageViewRetryButton_isVisibleOnInvalidImageData() {
        ...
        XCTAssertEqual(view?.isShowingRetryAction, true, "Expected retry action once image loading complete with invalid image data")
    }
    ...
    func test_feedImageViewRetryAction_retriesImageLoad() {
        ...
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url, image0.url, image1.url], "Expected fourth imageURL request after view retry action")
    }
    ...
    private func makeSUT(file: StaticString = #file, line: UInt = #line) -> (sut: FeedViewController, loader: LoaderSpy) {
        ...
        let sut = FeedIUComposer.feedComposedWith(feedLoader: loader, imageLoader: loader)
    ...
    private func assertThat(_ sut: FeedViewController, hasViewConfiguredFor image: FeedImage, at index: Int, file: StaticString = #file, line: UInt = #line) {
        ...
        let shouldLocationVeVisible = (image.location != nil)
        XCTAssertEqual(cell.isShowingLocation, shouldLocationVeVisible, "Expected `isShowingLocation` to be \(shouldLocationVeVisible) for image view at index (\(index))", file: file, line: line)
